# Add this or update your existing translations dictionary in translations.py
translations = {
    "English": {
        "title": "Smart Pesticide Assistant",
        "subtitle": "AI-Powered Crop Health & Spray Advisor",
    ...
    "Telugu": {
        ...
        "subtitle": "AI ఆధారిత పంట ఆరోగ్యం & స్ప్రే సలహాదారు",
        "description": "తెగుళ్లు/వ్యాధులను గుర్తించడానికి మరియు సరైన, పర్యావరణ అనుకూలమైన చికిత్స సలహాలను పొందడానికి మీ పంట చిత్రాన్ని అప్‌లోడ్ చేయండి.",
        "upload": "పంట చిత్రాన్ని ఎంచుకోండి...",
        "warning": "గమనిక: సిఫార్సు చేయబడిన ఏదైనా రసాయన పరిష్కారాలను వర్తించే ముందు దయచేసి స్థానిక వ్యవసాయ నిపుణుడిని సంప్రదించండి.",
        "tabs": ["🔍 పంట నిర్ధారణ", "💬 రైతు చాట్‌బాట్", "🌤️ వాతావరణ స్ప్రే సలహాదారు", "💰 ఖర్చు అంచనా"],
        "chatbot_header": "💬 అగ్రిబోట్ - మీ వ్యవసాయ తోడు",
    ...
    "Hindi": {
        ...
        "subtitle": "AI-संचालित फसल स्वास्थ्य और स्प्रे सलाहकार",
